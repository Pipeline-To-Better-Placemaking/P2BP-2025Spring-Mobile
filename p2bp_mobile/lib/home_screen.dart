              ...
              children: [
                  ...
                  child: Stack(
                    children: [
                      Align(
                        ...
                        child: Image.asset('assets/P2BP_Logo.png',
                            width: 40, height: 40),
                      ),
                      Align(
                  ...
                  child: Row(
                    ...
                    children: [
                      ShaderMask(
                        shaderCallback: (bounds) {
                          return const LinearGradient(
                            colors: [Color(0xFF0A2A88), Color(0xFF62B6FF)],
                ...
                Column(
                  children: [
                    ...
                    // Second Project Card
                    buildProjectCard(context, 'assets/PinkHouse.png',
                        'Project Neocity', 'Team: New Horizons Placemakers')
                  ],
                ),
                  ...
                  child:
                    ...
                    ElevatedButton(
                        ...
                        child: const Text('Results',
                            style: TextStyle(
                                fontSize: 12, color: Color(0xFF1D4076))))
                  ]))
            ],
          ),
        ));
